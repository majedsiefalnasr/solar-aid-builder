      ...
      <main className="mx-auto max-w-6xl px-4 pb-20 pt-12 md:px-8">
        <div className="grid gap-6 md:grid-cols-2">
          <ToolCard
            ...
            title="حاسبة البناء"
            desc="احصل على تقدير شامل لتكلفة مشروعك بناءً على المساحة وعدد الأدوار وجودة التشطيب."
            features={[
              "حساب تقديري للتكلفة الإجمالية",
              "تكلفة المواد (60٪ من الإجمالي)",
              "تكلفة العمالة (30٪ من الإجمالي)",
              "تكلفة التصاميم والإشراف (10٪)",
            ]}
            time="~2 دقيقة"
            cta="ابدأ الحساب"
